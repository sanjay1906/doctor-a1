const { Order,Cab } = require("Models");
const { handleError } = require("Helper");

const createOrder = async(req,res,next)=>{

    try{
    const { patientId, hospitalId,userId,pickupLatitude,pickupLongitude,destinationLatitude,destinationLongitude,doctorId } = req.body;
    ...
    const destinationLocation = getLocationData(destinationLatitude,destinationLongitude);
